			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						@endcan
						@can('ارشيف الفواتير')						
							<li><a class="slide-item" href="{{ url('/' . $page='archive') }}"> أرشيـــف الفواتيـــــر </a></li>
						@endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							@can('تقرير العملاء')
								<li><a class="slide-item" href="{{ url('/' . $page='Cst_Report') }}"> تقرير العملاء </a></li>
							@endcan

						</ul>
					</li>
					@can('المستخدمين') <li class="side-item side-item-category">المستخدمين</li> @endcan
					<li class="slide">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							@endcan
							@can('المنتجات')
								<li><a class="slide-item" href="{{ url('/' . $page='products') }}"> المنتجـــــات </a></li>
							@endcan
						</ul>
					</li>
				</ul>
