					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-primary-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="">
									<h6 class="mb-3 tx-15 text-white">   عدد الفواتيـــــر الكلي
								...
								<div class="">
									<h6 class="mb-3 tx-22 text-white"> إجمالى الفواتيـــــر </h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-success-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="">
									<h6 class="mb-3 tx-15 text-white"> عدد الفواتيـــــر المدفوعة
										<span class="my-auto mr-auto"> ( 
								...
								<div class="">
									<h6 class="mb-3 tx-22 text-white"> الفواتيـــــر المدفوعة </h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-danger-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="">
									<h6 class="mb-3 tx-15 text-white">   عدد الفواتيـــــر الغير مدفوعة
										<span class="my-auto mr-auto"> ( 
								...
								<div class="">
									<h6 class="mb-3 tx-22 text-white"> الفواتيـــــر غير المدفوعة </h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-warning-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="">
									<h6 class="mb-3 tx-15 text-white">   عدد الفواتيـــــر المدفوعة جزئيا
										<span class="my-auto mr-auto"> ( 
								...
								<div class="">
									<h6 class="mb-3 tx-22 text-white"> الفواتيـــــر المدفوعة جزئيا </h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
